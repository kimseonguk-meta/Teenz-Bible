...
// Uploads photo to Firebase Storage and stores the short download URL in RTDB.
// Falls back to compressed base64 in RTDB if the Storage upload fails.
...
// Upload photo to Firebase Storage and store the short download URL in RTDB.
// Falls back to compressed base64 in RTDB if the Storage upload fails,
// so photo upload keeps working even when Storage rules block the write.
...
// Convert a data: URL to a Blob for the Storage upload.
