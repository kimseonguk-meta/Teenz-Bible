...
function getLocalProfile(): any {
  return safeParseJSON<any>("teensBibleProfile", { nickname: "Anonymous", avatar: "😎", groupCode: "GLOBAL", joinedAt: Date.now(), isNasumMember: false });
}
...
export function getLocalGroups(): GroupMembership[] {
  return safeParseJSON<GroupMembership[]>("teensBibleGroups", []);
}
