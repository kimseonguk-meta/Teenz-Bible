...
src = repo / 'app'
dst = Path('/tmp/teenz-ota-1194-final')
zip_path = Path('/tmp/teenz-1.1.194-final.zip')
...
assert 'runtime-fixes-1.1.194.js' in index
assert 'runtime-fixes-1.1.194.css' in index
assert 'assets/index-GemFix1184.js' in index
assert not any(f'index-GemFix{v}' in index for v in ('1185', '1186', '1187', '1188', '1189'))
runtime = (dst / 'runtime-fixes-1.1.194.js').read_text(encoding='utf-8')
...
assert '[data-loc="client/src/pages/Profile.tsx:1141"]' in (dst / 'runtime-fixes-1.1.194.css').read_text(encoding='utf-8')
assert '[data-loc="client/src/pages/Profile.tsx:1142"]' in (dst / 'runtime-fixes-1.1.194.css').read_text(encoding='utf-8')
css = (dst / 'runtime-fixes-1.1.194.css').read_text(encoding='utf-8')
...
shutil.copy2(zip_path, ota_dir / '1.1.194.zip')
manifest = {'version': '1.1.194', 'url': 'https://teens-bible-94271.web.app/ota/1.1.194.zip', 'checksum': sha256, 'size': size}
