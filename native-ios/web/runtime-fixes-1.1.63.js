(() => {
  ...
  const applyOnboardingGuidanceExperience = () => {
    ...
    if (localStorage.getItem('teensBibleOnboardingDone') === 'true' && reading && !first60State.dismissed && !document.getElementById('tb-first60-overlay')) {
      const overlay = document.createElement('div');
