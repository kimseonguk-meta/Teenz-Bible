...
> **다음 AI·개발자를 위한 단일 시작점:** 새 작업을 시작하기 전에 먼저 [`docs/TEENZ_BIBLE_MASTER_HANDOFF.md`](docs/TEENZ_BIBLE_MASTER_HANDOFF.md)를 읽으세요. 이 README는 2026-08-13 정적 Hosting 복구 이력을 설명하고, 이후의 **OTA 1.1.127**, **iOS 1.2.1 (Build 6)**, Firebase 안전 기능·App Store 상태는 마스터 인수인계 문서가 최신 기준입니다.
